...
import click
from lib import TableMap, read_csv, format_phone, utc_from_timestamp

table_map = TableMap(
  database_url=os.environ.get('DATABASE_URL'),
  tablename='active_rental_licenses',
  mapping=[
    ('\ufeffapn', 'apn', str, None),
    ...
    ('tier', '', str, None),
    ('status', '', str, None),
    ('issueDate', 'issue_date', date, utc_from_timestamp),
...
def transfer(path):
  ...
  table_map.transfer_data(read_csv(path))
